...
// const testimonalContent = document.querySelector('.testimonals-contents')
// const testimonalItems = document.querySelectorAll('.testimonals-item ')
// const testimonalBtnL = document.querySelector('.testimonal-btn-left')
// const testimonalBtnR = document.querySelector('.testimonal-btn-right')


// let t_counter = 1;
// let t_size = testimonalItems[0].clientWidth;
// console.log(t_size);

// testimonalContent.style.transform = 'translateX(' + (-t_size * t_counter) + 'px)';

// testimonalBtnR.addEventListener('click', () =>{
//     if (counter >= testimonalContent -1) {
//         return
//     }
//     t_counter++
//     testimonalContent.style.transition = 'transform 0.4s ease-in-out';
//     testimonalContent.style.transform = 'translateX(' + (-t_size * t_counter) + 'px)';

// })
// testimonalBtnL.addEventListener('click', () =>{
//     if (counter <= 0 ) {
//         return;
//     }
//     t_counter--
...
// testimonalContent.addEventListener('transitionend', () =>{
//     if (testimonalContent[counter].id === 'lastClone') {
//         counter = testimonalContent.length -2;
//         testimonalContent.style.transition = 'none';
//         testimonalContent.style.transform = 'translateX(' + (-t_size * t_counter) + 'px)';
//     }
//     if (testimonalContent[counter].id === 'firstClone') {
//         counter = testimonalContent.length - counter;
//         testimonalContent.style.transition = 'none';
//         testimonalContent.style.transform = 'translateX(' + (-t_size * t_counter) + 'px)';
//     }
// })